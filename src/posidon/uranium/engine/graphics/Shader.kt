...
public class Shader {
    ...
    public void setUniform(String name, Vec2f value) { GL20.glUniform2f(getUniformLocation(name), value.x, value.y); }
    public void setUniform(String name, Vec3f value) { GL20.glUniform3f(getUniformLocation(name), value.x, value.y, value.z); }
